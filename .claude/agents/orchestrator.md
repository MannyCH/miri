...
**Default to fixing directly.** Only create a Notion card when you genuinely cannot fix it — not when it's slightly inconvenient.

### Always fix directly (no card needed):
